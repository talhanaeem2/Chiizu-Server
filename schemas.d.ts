...
export interface ApiHomeHome extends CollectionTypeSchema {
  info: {
    singularName: 'home';
    pluralName: 'homes';
    displayName: 'Home';
  ...
  attributes: {
    HeroHeading: StringAttribute;
    payments: ComponentAttribute<'payment.payments', true>;
    stories: ComponentAttribute<'story.stories', true>;
    createdAt: DateTimeAttribute;
    updatedAt: DateTimeAttribute;
...
export interface PaymentPayments extends ComponentSchema {
  info: {
    displayName: 'payments';
    description: '';
  };
  attributes: {
    main_img: MediaAttribute;
    title: StringAttribute;
    description: TextAttribute;
  };
}

export interface StoryStories extends ComponentSchema {
  info: {
    displayName: 'stories';
  };
  attributes: {
